...
>>>>>>> 21671a811a3487d7dfe054621db1ddf664665dfc
>>>>>>> Stashed changes
    ...
    <div class='containerinscription'>
        ...
        <form method="POST" action="requete_inscriptioncoach.php">
            <div class="encadrer">
                ...
                <div class="search-container">
                    <input type="text" name="confirme_adresse_mail" placeholder="CONFIRMER L'ADRESSE MAIL" required/>
                </div>
                ...
                <div class="search-container">
                    <input type="password" name="confirme_mot_de_passe" placeholder="CONFIRMER LE MOT DE PASSE" required/>
